...
- **Tianxiang Zhao**, Youqing Wang, Jinlu Wang, Jiapu Wang, Mingliang Cui, Junbin Gao, Jipeng Guo*. "Hybrid-Collaborative Augmentation and Contrastive Sample Adaptive-Differential Awareness for Robust Attributed Graph Clustering", _**NeurIPS**_, 2025. [[PDF]](extension://ngbkcglbmlglgldjfcnhaijeecaccgfi/https://openreview.net/pdf?id=fb7maZToPl) [[Code]](https://github.com/TianxiangZhao0474/RAGC.git)

**<span style="color:green;">[2024]</span>**
-  Jipeng Guo, Tengxiao Yin, **Tianxiang Zhao**, Jiayi Zhao, Yanfeng Sun, Junbin Gao, and Youqing Wang*. "Improved attributed graph clustering with representation and structure augmentation", _**In Proceedings of International Joint Conference on Neural Networks (IJCNN)**_, 2024. [[PDF]](https://ieeexplore.ieee.org/abstract/document/10650771)
